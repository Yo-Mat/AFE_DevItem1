...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=1, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=0, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=1, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=PWM_AFE, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_AFE, CY_INSTANCE_SHORT_NAME=PWM_AFE, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_AFE, )
...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=500000, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=0, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=999999, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=32, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM, CY_INSTANCE_SHORT_NAME=PWM, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM, )
...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=10000, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=0, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=20000, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=32, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=PWM_CYC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_CYC, CY_INSTANCE_SHORT_NAME=PWM_CYC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_CYC, )
...
module top ;
	...
	wire [0:0] tmpIO_0__AFE1_RDY_net;
	electrical [0:0] tmpSIOVREF__AFE1_RDY_net;
	...
	cy_mxs40_gpio_v1_0
		...
		AFE1_RDY
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({Net_592}),
		  .io({tmpIO_0__AFE1_RDY_net[0:0]}),
		  .siovref(tmpSIOVREF__AFE1_RDY_net));
	...
	wire [0:0] tmpIO_0__AFE0_RDY_net;
	electrical [0:0] tmpSIOVREF__AFE0_RDY_net;
	...
	cy_mxs40_gpio_v1_0
		...
		AFE0_RDY
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({Net_591}),
		  .io({tmpIO_0__AFE0_RDY_net[0:0]}),
		  .siovref(tmpSIOVREF__AFE0_RDY_net));
	...
	wire [0:0] tmpFB_0__Pin_AFE_CLK_net;
	wire [0:0] tmpIO_0__Pin_AFE_CLK_net;
	electrical [0:0] tmpSIOVREF__Pin_AFE_CLK_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_AFE_CLK
		 (.oe({1'b1}),
		  .y({Net_372}),
		  .fb({tmpFB_0__Pin_AFE_CLK_net[0:0]}),
		  .io({tmpIO_0__Pin_AFE_CLK_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_AFE_CLK_net));
	...
	cy_clock_v1_0
		#(.id("c82f74e8-dcf3-4276-9667-1471af994976"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("250000000"),
		  .is_direct(0),
