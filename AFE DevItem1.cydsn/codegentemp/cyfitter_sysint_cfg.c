...
/* ARM CM4 */
    ...
    /* I2C_2_SCB_IRQ */
    const cy_stc_sysint_t I2C_2_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)I2C_2_SCB_IRQ__INTC_NUMBER,
        .intrPriority = I2C_2_SCB_IRQ__INTC_CORTEXM4_PRIORITY
    };
    ...
    /* ISR_AFE0 */
    const cy_stc_sysint_t ISR_AFE0_cfg = {
        .intrSrc = (IRQn_Type)ISR_AFE0__INTC_NUMBER,
        .intrPriority = ISR_AFE0__INTC_CORTEXM4_PRIORITY
    };

    /* ISR_AFE1 */
    const cy_stc_sysint_t ISR_AFE1_cfg = {
        .intrSrc = (IRQn_Type)ISR_AFE1__INTC_NUMBER,
