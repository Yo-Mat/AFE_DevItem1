...
/* ARM CM4 */
    ...
    #define I2C_2_SCB_IRQ__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t I2C_2_SCB_IRQ_cfg;

    #define UART_SCB_IRQ__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t UART_SCB_IRQ_cfg;

    #define ISR_AFE0__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t ISR_AFE0_cfg;

    #define ISR_AFE1__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t ISR_AFE1_cfg;

    #define ISR_CYC__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t ISR_CYC_cfg;

    #define ISR_TIM__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t ISR_TIM_cfg;
