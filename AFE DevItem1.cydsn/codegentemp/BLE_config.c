...
static uint8_t cy_ble_attValues[0x2Bu] = {
    /* Device Name */
    (uint8_t)'P', (uint8_t)'S', (uint8_t)'o', (uint8_t)'C', (uint8_t)'S', (uint8_t)'p', (uint8_t)'O', (uint8_t)'2', 
    ...
    /* SpO2CUD */
    (uint8_t)'S', (uint8_t)'p', (uint8_t)'O', (uint8_t)'2', (uint8_t)' ', (uint8_t)'d', (uint8_t)'a', (uint8_t)'t',
(uint8_t)'a', 
    ...
    (uint8_t)'L', (uint8_t)'E', (uint8_t)'D', (uint8_t)' ', (uint8_t)'s', (uint8_t)'i', (uint8_t)'g', (uint8_t)'n', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Fu] = {
    ...
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* SpO2 UUID */
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* SpO2Data UUID */
    { 0x0001u, (void *)&cy_ble_attValues[24] }, /* SpO2Data */
    { 0x0009u, (void *)&cy_ble_attValues[25] }, /* SpO2CUD */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[2] }, /* SpO2CCCD */
    { 0x0010u, (void *)&cy_ble_attUuid128[2] }, /* LED UUID */
    { 0x0001u, (void *)&cy_ble_attValues[34] }, /* LED */
    { 0x0008u, (void *)&cy_ble_attValues[35] }, /* Characteristic User Description */
};

static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x17u] = {
