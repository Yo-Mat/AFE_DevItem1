...
#define CY_BLE_CONFIG_GATT_DB_ATT_VAL_COUNT         (0x0Fu)
 ...
 */
#define CY_BLE_SPO2_SERVICE_INDEX   (0x00u) /* Index of SpO2 service in the cy_ble_customs array */
#define CY_BLE_SPO2_SPO2DATA_CHAR_INDEX   (0x00u) /* Index of SpO2Data characteristic */
#define CY_BLE_SPO2_SPO2DATA_SPO2CUD_DESC_INDEX   (0x00u) /* Index of SpO2CUD descriptor */
#define CY_BLE_SPO2_SPO2DATA_SPO2CCCD_DESC_INDEX   (0x01u) /* Index of SpO2CCCD descriptor */
#define CY_BLE_SPO2_LED_CHAR_INDEX   (0x01u) /* Index of LED characteristic */
#define CY_BLE_SPO2_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CY_BLE_SPO2_SERVICE_HANDLE   (0x0010u) /* Handle of SpO2 service */
#define CY_BLE_SPO2_SPO2DATA_DECL_HANDLE   (0x0011u) /* Handle of SpO2Data characteristic declaration */
#define CY_BLE_SPO2_SPO2DATA_CHAR_HANDLE   (0x0012u) /* Handle of SpO2Data characteristic */
#define CY_BLE_SPO2_SPO2DATA_SPO2CUD_DESC_HANDLE   (0x0013u) /* Handle of SpO2CUD descriptor */
#define CY_BLE_SPO2_SPO2DATA_SPO2CCCD_DESC_HANDLE   (0x0014u) /* Handle of SpO2CCCD descriptor */
#define CY_BLE_SPO2_LED_DECL_HANDLE   (0x0015u) /* Handle of LED characteristic declaration */
#define CY_BLE_SPO2_LED_CHAR_HANDLE   (0x0016u) /* Handle of LED characteristic */
#define CY_BLE_SPO2_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0017u) /* Handle of Characteristic User Description descriptor */
