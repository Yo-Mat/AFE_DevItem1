...
static const uint8_t tia_gain[TIA_GAIN_NUM] = {6,0,1,2,3,4,5};  // 1M,500k,250k,100,50k,25k,10k
...
#define SMP_SKIP    1   // サンプルスキップ数
// TIAゲイン
#define TIA2_ID     0   // LED2 TIA 初期値ID(1MΩ)
#define TIA1_ID     0   // LED1 TIA 初期値ID(1MΩ)
#define EnsepGain   1   // separate gain enabled(1) or not(0).
#define TIA_G2      6   // resistance for second TIA 初期値(1MΩ)
#define TIA_C2      1   // capacitance for second TIA
#define TIA_G1      6   // resistance for first TIA 初期値(1MΩ)
...
// LED電流
#define I_LED1      6   // IR led current 0-63 (=0-50.4mA) 初期値(4.8mA)
#define I_LED2      6   // RED led current 0-63 (=0-50.4mA) 初期値(4.8mA)
